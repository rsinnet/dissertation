...
%
For an edge $e = \{v, v'\} \in E$, the post-impact velocity $\dq^+$ is given in terms of the pre-impact velocity $\dq^-$ by balancing angular momentum \cite{HM94}.
%
Using the Schur complement \cite{Fuzhen05}, the post-impact velocity can be written:
%
\begin{align}
  \label{eq:pmap}
...
%
this ``trick'' is common throughout the literature \cite{GAP01}.
%
