...
continuous for any given point in $\D$.\todo{More about IFT.}\xspace
%
...
choosing the \Poincare{} section to correspond to impact events.\todo{Mention
  Zeno.}\xspace
%
...
$J\argsq$, whose rows contain individual constraints.\todo{Missing
  something.}\xspace
%
...
In an attempt to simplify the model and obtain bi-periodic behavior in the
...
kinematic constraints on the system.\todo{Also non-holonomic.}\xspace
%
...
% {\em Hybrid systems} or {\em systems with impulse effects}\cite{GAP01}\xspace
%have been studied extensively in a wide variety of contexts and have been used
%to model a wide range of bipedal robotic systems.\cite{GCAS10}\xspace This
%section introduces a definition of hybrid systems applicable to bipedal
%walking.
