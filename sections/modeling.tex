...
Consider a simple hybrid system given by \eqref{eq:hsys}.
%
...
For additional notions of solutions, see \cite{Filippov1988, Goebel2009,
  Haddad2001, Lygeros2003, Ye1998}.
...
therefore, natural to model bipedal robots as hybrid systems.\todo{Move parts of
  this to earlier sections.}\xspace
%
...
Given a vertex $v \in V$, the domain $\D$ is the set of admissible
...
%
For an edge $e = \{v, v'\} \in E$, the post-impact velocity $\dq^+$ is given in
terms of the pre-impact velocity $\dq^-$ by balancing angular momentum
\cite{Hurmuzlu1994}.
%
