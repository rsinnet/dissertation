...
%
Stability of systems has a long history, appearing in the works of researchers
such as Routh \cite{Routh1877} and Hurwitz \cite{Hurwitz1895}.
%
...
stability but lacked the notion of {\em uniform stability} which was necessary
for establishing necessary conditions.
%
As explained in the literature (see, e.g., \cite{Michel2007,Teel1999}, the
assumptions of uniformity were not formulated until much later in the work of
Malkin \cite{Malkin1954}, building on an earlier paper by Massera
\cite{Massera1949} which introduced the notion of {\em equiasymptotic
  stability}.
%

\cite{Malkin1938}

Using the newly-established results on uniform stability, Massera
\cite{Massera1956} set forth necessary conditions for Lyapunov stability which
are now generally referred to as {\em converse Lyapunov theorems}.
