...
summarized in numerous texts; see, e.g, \cite{Yoshizawa1975}.
...
%
Cesari provides an answer for \cite[\S 1.5]{Cesari1971} for second-order
linear systems.
%
Strauss introduces $L^{p}$ stability to attempt to answer this question for more
