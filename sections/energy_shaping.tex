...
\begin{align}
  ...
  E_{0} \equiv \Ec\argsqdqt = T\argsqdqt + U\argsqt - \W(\q\argzero,
  \dq\argzero, t).
\end{align}
with the storage function $\W : T\Q \times \Rnn \to \R$ defined by
\begin{align}
  \label{eq:storage-function-Fnc}
  \W(\q\argzero, \dq\argzero, t) = \int_{0}^{t} \! \Fnc\argtau \cdot
  \frac{d\q\argtau}{d\tau} \ d\tau
\end{align}
...
\begin{align}
  ...
  W(\q\argzero, \dq\argzero, t) = \int_{0}^{t} \! \B\argsqtau \, \vv\argsqdqtau \cdot \frac{dq\argtau}{d\tau} \ d\tau.
\end{align}
