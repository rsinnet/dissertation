...
information is available in \cite{Full1999, Holmes2006, Wisse2007, Kuo2007,
  Siciliano2008, Chevallereau2009, Sadati2012}
...
%
%One of the more popular models considered for bipedal walking is the Linear
%Inverted Pendulum Model (LIPM), which represents a robot as a point mass with
%massless telescoping legs.
%
...
%
%ntuitively, a capture point is a point on the ground where a biped can place
...
%\textbf{JWG: disucss how early implementations used offline trajectory
%computation, while more recently, on-line planning via an linear inverted
%pendulum model and a QP are used (Weiber)?}
