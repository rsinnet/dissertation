...
\begin{figure}[t!]
  \centering
  \includegraphics[width=1.0\textwidth]{LabeledDiagram}
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=1.0\textwidth]{subject_range_graph}
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=1.0\columnwidth]{domainbreaking}
...
\begin{figure}
  \centering
  \includegraphics[width=.5\columnwidth]{robot_angles}
