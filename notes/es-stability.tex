...
\begin{proof}
  ...
  Next, since the reset map is locally Lipschitz continuous about the fixed point $\argsxz = \argszero$ and because $\DeltaX\argszero = 0$, it follows that
  \begin{align}
  ...
  \begin{align}
    \nonumber
    \int_{\TIDelta}^{\TIeDelta)} \! \hspace{-1em} \left\| \bigF\argsxz \right\| \, d\tau
