...
\begin{proof}
  ...
  \begin{align}
    \nonumber
    \lambdamaxG &:= \sup_{\ell \in \R} \{ \ell = \lambdamax\bigG\argsxz : \argsxz \in \stabletube \},\\
    \lambdaminG &:= \inf_{\ell \in \R} \{ \ell = \lambdamin\bigG\argsxz : \argsxz \in \stabletube \}.
  \end{align}
  ...
  \begin{align}
    ...
    \lefteqn{\left\| \floweps_{\TIe(\zdx,\zdz)}\argsxz - \flow_{\TI(\zdx,\zdz)}\argsxz \right\| \leq}\\
    \nonumber
    && \int_{\TI\argsxz}^{\TIe\argsxz} \hspace{-2em} \left\| \bigF\argsxz \right\| \, d\tau
      + \int_{0}^{\TIe\argsxz} \hspace{-2em} \left\| \bigG\argsxz \, \mueps\argstxz \, \right\| d\tau.
  \end{align}
  %
  For simplicity, consider the two terms separately.
  %
  If $\bigF$ is bounded around the limit cycle, then
  \begin{align}
    \nonumber
    \int_{\TI\argsxz}^{\TIe\argsxz} \! \left\| \bigF\argsxz \right\| \, d\tau
    &\leq \supF \int_{\TI\argsxz}^{\TIe\argsxz} d\tau\\
    \nonumber
    &\leq \left.\supF \tau\right|_{\tau=\TI\argsxz}^{\TIe\argsxz}\\
    \nonumber
    &\leq \supF \left(\TIe\argsxz - \TI\argsxz\right)\\
    \label{eq:F-bound}
    &\leq \supF \ATIe \nzdxz.
  \end{align}
  ...
  \begin{align}
    \nonumber
    \int_{0}^{\TIe\argsxz} \! &\left\| \bigG \, \mueps\argstxz \, \right\| d\tau\\
    \nonumber
    &\leq \frac{c_{2}c_{3}}{\resclfparam^{3}} \frac{\lambdamaxG^{2}}{\lambdaminG^{2}} \int_{0}^{\TIe\argsxz} \! \nzdxt d\tau\\
    \nonumber
    &\leq \frac{c_{2}^{\frac{3}{2}}c_{3}}{c_{1}^{\frac{1}{2}}\resclfparam^{4}} \frac{\lambdamaxG^{2}}{\lambdaminG^{2}} \|\zdx(0)\| \int_{0}^{\TIe\argsxz} \! \left\|e^{-\frac{c_{3}}{2\resclfparam} \tau} \right\| d\tau\\
    \label{eq:G-bound}
    &\leq \frac{c_{2}^{\frac{3}{2}} c_{3}^{2}}{2c_{1}^{\frac{1}{2}}\resclfparam^{5}} \frac{\lambdamaxG^{2}}{\lambdaminG^{2}} \left\|\zdx(0)\right\| \, \left. e^{-\frac{c_{3}}{2\resclfparam} \tau} \right|^{0}_{\tau=\TIe\argsxz}.
  \end{align}
  %
  ...
  \begin{align}
    ...
    \lefteqn{\int_{0}^{\TIe\argsxz} \! \left\| \bigG \, \mueps\argstxz \, \right\| d\tau \leq}\\
    \nonumber
  ...
  \begin{align}
    \left\| \floweps_{\TIe(\zdx,\zdz)}\argsxz - \flow_{\TI(\zdx,\zdz)}\argsxz \right\| \leq \Ae \! \nzdxz,
  \end{align}
  where
  \begin{align}
    \lefteqn{\Ae :=} \\
    \nonumber
    &&\LDelta \frac{c_{2}^{\frac{3}{2}} c_{3}^{2}}{2c_{1}^{\frac{1}{2}}\resclfparam^{5}} \frac{\lambdamaxG^{2}}{\lambdaminG^{2}}  \, \left(1 - e^{-\frac{c_{3}}{2\resclfparam} 1.1 \Tst}\right) + \supF \ATIe. &\qedhere
  \end{align}
\end{proof}
