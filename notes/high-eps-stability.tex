...
\begin{lemma}
  ...
  The time-to-impact function $\TIe\argsxz$ satisfies
  \begin{align}
    \label{eq:TIe-bounds}
...
\begin{proof} [Proof of \thmref{theorem:main-theorem}]
  ...
  \end{align}
  for some $\argsxz \in \B_{\gamma}(0, \boldzero)$ with $\gamma \in \Rpd$ where $\LDelta$ is the Lipschitz constant of $\Delta\argsxz$.
  %
  ...
  \begin{align}
    \Vex(\Pex\argsxz) - \Vex(\zdx) \leq -c_{1} \| \zdx \|^{2} + \beta_{1} \| \argsxz \|^{2}.
  \end{align}
