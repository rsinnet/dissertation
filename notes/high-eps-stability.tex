...
\begin{proof}
  ...
  \end{align}
  {\bf If the reset map is locally Lipschitz about the fixed point $(\zdxst, \zdzst)$, then
    \begin{align}
      \label{eq:Veh-bound}
      \| \Delta(\zdx, \zdz) - \Delta(\zdx + \gamma, \zdz + \gamma) \| \leq L_{\Delta} \| (\delta\zdx, \delta\zdz) \|
    \end{align}
    in some conservative ball $\B_{\gamma}(\zdxst, \zdzst)$ for some $(\delta\zdx, \delta\zdz) \in \B_{\gamma}(\zdxst, \zdzst)$.}
  ...
  \begin{align}
    ...
    \Vee&(\Pe^{\zdx}(\zdx, \zdz))\\
    \nonumber
    &\leq c_{2} e^{-c_{3} T_{I}(\zdx, \zdz)} \big\| \Delta_{\zdx}(\zdx, \zdz) - \Delta_{\zdx}(\zdx - \delta \zdx, \zdz + \delta \zdz)\\
    \nonumber
    & \hspace{3.5cm}  + \Delta_{\zdx}(\zdx + \delta \zdx, \zdz + \delta \zdz)\big\|^{2}\\
    \nonumber
    &\leq c_{2} e^{-c_{3} T_{I}(\zdx, \zdz)} \Big( \big\| \Delta_{\zdx}(\zdx, \zdz) - \Delta_{\zdx}(\zdx + \delta \zdx, \zdz + \delta \zdz) \big\|^{2}\\
    \nonumber
    & \hspace{3.5cm} + \big\| \Delta_{\zdx}(\zdx + \delta \zdx, \zdz + \delta \zdz)\big\|^{2} \Big)\\
    \nonumber
    &\leq c_{2} e^{-c_{3} T_{I}(\zdx, \zdz)} \Big( L_{\Delta}^{2} \| (\delta \zdx, \delta \zdz) \|^{2}\\
    \nonumber
    & \hspace{3.5cm} + \big\| \Delta_{\zdx}(\zdx + \delta \zdx, \zdz + \delta \zdz)\big\|^{2} \Big)
  \end{align}
