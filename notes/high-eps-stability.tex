...
\begin{proof}
  ...
  Since the reset map is locally Lipschitz about the fixed point $(\zdx, \zdz) = (0, \boldzero)$, it holds that
    \begin{align}
      \| \Delta(\zdx, \zdz) - \Delta(0, \boldzero) \| \leq L_{\Delta} \| (\zdxp, \zdzp) \|
    \end{align}
  ...
  \begin{align}
    ...
    \Vee&(\Pe^{\zdx}(\zdx, \zdz))\\
    \nonumber
    &\leq c_{2} e^{-c_{3} T_{I}(\zdx, \zdz)} \big\| \Delta_{\zdx}(\zdx, \zdz) - \Delta_{x}(0, \boldzero) \big\|^{2}\\[1em]
    \nonumber
    &\leq c_{2} e^{-c_{3} T_{I}(\zdx, \zdz)} L_{\Delta}^{2} \| (\zdxp, \zdzp) \|^{2}.
  \end{align}
