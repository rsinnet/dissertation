    ...
    \begin{block}{Conservative Systems}
      ...
      \begin{align*}
        \HCS = \left\{
          ...
          \end{array}\right.
      \end{align*}
      For a \blue{conservative system}, $\uu \equiv \boldzero$.
      %, which leads to the hybrid system
      %\begin{align*}
      %  \HS = \left\{
      %    \begin{array}{l l}
      ...
      %    \end{array}\right.
      %\end{align*}
      For simplicity of exposition when dealing with conservative systems,
      define $\xfbar\arx = \xf\arx$ and
      \begin{align*}
        \HCSbar = \left\{
          \begin{array}{l l}
