...
\renewcommand{\tamumanuscripttitle}{Energy Shaping of Mechanical Systems via
  Control Lyapunov Functions with Applications to Bipedal Locomotion}
\renewcommand{\tamupapertype}{Dissertation}
\renewcommand{\tamufullname}{Ryan Wesley Sinnet}
\renewcommand{\tamudegree}{Doctor of Philosophy}
\renewcommand{\tamuchairone}{Aaron Ames}
